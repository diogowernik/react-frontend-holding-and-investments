...
import { fetchPortfolioAssets, fetchPortfolioDividends,fetchPortfolioQuotas} from '../apis';
...
const Portfolio = () => {
  ...
  const categories_total_usd = total_usd_by('category')
  const brokers_total_usd = total_usd_by('broker')
  const fiis_total_usd = total_usd_by('subcategory','Fundos Imobiliários')
  const br_stocks_total_usd = total_usd_by('subcategory','Ações Brasileiras')
  const REITs_total_usd = total_usd_by('subcategory','REITs')
  const stocks_total_usd = total_usd_by('subcategory','Stocks')
            ...
            <Tab.Content>
                ...
                <Row>
                    <Col lg={3}>
                        ...
                        group_total_usd={fiis_total_usd}    
                        />
                        {/* <PieChart
                        total={fiis_total}
                        /> */}
            ...
            <Tab.Content>
                ...
                <Row>
                    <Col lg={3}>
                        ...
                        group_total_usd={br_stocks_total_usd}  
                        />
                        <PieChart 
            ...
            <Tab.Content>
                ...
                <Row>
                    <Col lg={3}>
                        ...
                        group_total_usd={REITs_total_usd} 
                        />
                        <PieChart 
            ...
            <Tab.Content>
                ...
                <Row>
                    <Col lg={3}> 
                        ...
                        group_total_usd={stocks_total_usd}
                        />
                        <PieChart 
